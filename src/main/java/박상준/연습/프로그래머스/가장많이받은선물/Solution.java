package 박상준.연습.프로그래머스.가장많이받은선물;
...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(solution.solution(new String[]{"muzi", "ryan", "frodo", "neo"}, new String[]{"muzi frodo", "muzi frodo", "ryan muzi", "ryan muzi", "ryan muzi", "frodo muzi", "frodo ryan", "neo muzi"})); // 2
        System.out.println(solution.solution(new String[]{"joy", "brad", "alessandro", "conan", "david"}, new String[]{"alessandro brad", "alessandro joy", "alessandro conan", "david alessandro", "alessandro david"})); // 4
        System.out.println(solution.solution(new String[]{"a", "b", "c"}, new String[]{"a b", "b a", "c a", "a c", "a c", "c a"})); // 0
    }
    ...
    public int solution(String[] friends, String[] gifts) {
        ...
        for (String gift : gifts) {
            String[] way = gift.split(" ");
            String giver = way[0];
            String givener = way[1];
            
            final Map<String, Integer> givenMap = giftCounts.get(giver);
            
            final Integer count = givenMap.get(givener);
