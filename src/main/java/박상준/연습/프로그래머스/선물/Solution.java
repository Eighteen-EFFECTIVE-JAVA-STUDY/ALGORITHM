package 박상준.연습.프로그래머스.선물;

import java.util.HashMap;
import java.util.Map;

/**
 * packageName    : 박상준.연습.프로그래머스
 * fileName       : Solution
 * author         : ipeac
 * date           : 25. 2. 20.
 * description    :
...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println("====================================");
        System.out.println(solution.solution(new String[]{"joy", "brad", "alessandro", "conan", "david"}, new String[]{"alessandro brad", "alessandro joy", "alessandro conan", "david alessandro", "alessandro david"}));
        System.out.println("====================================");
        System.out.println(solution.solution(new String[]{"a", "b", "c"}, new String[]{"a b", "b a", "c a", "a c", "a c", "c a"}));
    }
